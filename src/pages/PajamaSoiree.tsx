    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-pink-200 via-pink-300 to-pink-400">
            ...
            >
              <div className="text-red-900 font-serif space-y-4 text-center">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 bg-red-700 hover:bg-red-800 text-white font-bold text-sm px-5 py-2 rounded-full shadow-lg transition-colors"
                >
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 flex items-center justify-center min-h-screen">
        <div className="max-w-3xl w-full text-center animate-fade-in">
          ...
          {/* Event title */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-serif italic text-red-600 mb-2">
              Elevated
            </h1>
            <h2 className="text-2xl md:text-3xl font-serif italic text-red-700 mb-4">
              Love Letter <span className="text-xl md:text-2xl">to a</span> Young Sister
            </h2>
            <h3 className="text-3xl md:text-4xl font-bold text-red-700 tracking-wide mb-4">
              PAJAMA SOIREE
            </h3>
